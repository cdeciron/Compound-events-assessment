...
##Version number
v_number = 'v1' #'v1' or 'v2'; in file name
...
geo_data_path = f"/{location}/{disk}/Compound_events_study_folder/Geospatial_data"
...
def compute_regional_means(ds, shapes):
    ...
    # Use cftime objects directly as index to avoid conversion errors
